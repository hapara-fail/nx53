...
Thank you for your interest in the security of **nx53**. We take the security of our software and the privacy of our users very seriously.
...
1.  **Subject Line:** Must contain `nx53` and `vulnerability`.
    - _Example:_ `nx53 vulnerability: Bypass firewall with malformed packet`
2.  **Body Content:**
